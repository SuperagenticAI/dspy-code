...
This script uses GEPA (Genetic Prompt Evolution Algorithm) to optimize your DSPy module.
...
'''
    ...
    if not dataset_file.exists():
        print(f"⚠️  Training data not found: {{path}}")
        ...
        print(f"✓ Created example training data: {{path}}")
        print("  ⚠️  IMPORTANT: Replace with your actual training examples!")
...
def load_validation_data(path: str = "data/val.json"):
    ...
    if not dataset_file.exists():
        ...
        print(f"✓ Created example validation data: {{path}}")
        print("  ⚠️  IMPORTANT: Replace with your actual validation examples!")
    ...
    # Fallback to first available model
        ...
        print("⚠️  No model configured, using default: gpt-4")
    ...
    print()
    print("💡 Reflection Model Tips:")
    print("   • Stronger models (GPT-4, Claude-3-Opus) = better optimization")
    print("   • Local models (Ollama) work but may need more iterations")
    print("   • You can change the model in dspy_config.yaml")
    print()
    ...
    print(f"✓ Configured GEPA optimizer")
    ...
    print("This will:")
    print("  • Analyze your module's behavior")
    print("  • Generate improved prompts through reflection")
    print("  • Track multiple candidate solutions")
    print("  • Select the best performing variant")
    print()
    print("⏱️  This may take some time depending on budget...")
    print()
...
def main():
    ...
    if config.default_model:
        ...
        print("⚠️  No model configured, using default: ollama/llama3.2")
    ...
    print("⚠️  Please uncomment the import statement above")
    ...
    print()
    print("💡 Tips:")
    print("  • More training data = better optimization")
    print("  • Validation set should match your target distribution")
    print("  • Check optimization/logs/ for detailed progress")
    print("  • Use track_stats=True to analyze all candidates")
    print()'''
